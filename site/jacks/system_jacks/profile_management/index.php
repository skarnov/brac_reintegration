...
class dev_profile_management{
    ...
    function add_edit_user($args = array()){
        ...
        if(strcmp($temp_username,$args['user_name'])) $ret['error'][] = 'Username is not acceptable. You can try with <em>'.$temp_username.'</em>, if not already taken. Space is not allowed';
        ...
        else if($edit) $args['user_picture'] = $oldData['user_picture'];
        else $args['user_picture'] = '';
        
        if(!$ret['error']){
            $insertData = array(
                'user_fb_id' => $args['user_fb_id'],
                'fk_project_id' => $args['project_id'],
                ...
                'user_branch' => isset($args['user_branch']) ? $args['user_branch'] : 0,
                'user_designation' => isset($args['user_designation']) ? $args['user_designation'] : 0,
