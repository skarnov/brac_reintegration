				...
				<div class="tab-content tab-content-bordered">
                    ...
                    <div class="tab-pane fade" id="adminMenuSettings">
                        ...
                        <div class="form-group">
                                        ...
                                        <ul class="mb0 widget-tasks list-group adminMenuSortable" data-position="<?php echo $position?>">
                                            ...
                                            if($g){
                                                foreach($g as $gId=>$gItems){
                                                    ...
                                                    <?php echo $gId?>
                                                        <a href="javascript:" class="fa fa-minus-square pull-right show_hide_submenu"></a>
                                                    </div>
                            ...
                            <script type="text/javascript">
                                init.push(function(){
                                    $('.show_hide_submenu').on('click', function(){
                                        var ths = $(this);
                                        var container = ths.closest('li');
                                        if(container.find('>ul').is(':visible')){
                                            container.find('>ul').slideUp();
                                            ths.removeClass('fa-minus-square').addClass('fa-plus-square');
                                        }
                                        else{
                                            container.find('>ul').slideDown();
                                            ths.removeClass('fa-plus-square').addClass('fa-minus-square');
                                        }
                                    })
