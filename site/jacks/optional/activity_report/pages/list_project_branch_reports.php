...
$results = $this->get_branch_project_reports($args);
...
$count_results = $this->get_branch_project_reports($args);
...
if ($_GET['download_csv']) {
    ...
    $csvFile = $csvFolder . 'Project_and_Branch_Wise_MIS_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Project and Branch Wise MIS Report', '');
...
<div class="page-header">
    <h1>Project and Branch MIS Reports</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            <?php
            echo linkButtonGenerator(array(
                'href' => '?download_csv=1&project=' . $filter_project . '&branch=' . $filter_branch,
...
<div class="table-primary table-responsive">
    ...
    <div class="table-header">
        <?php echo searchResultText($results['total'], $start, $per_page_items, count($results['data']), 'Project and Branch MIS Report') ?>
    </div>
