...
$results = $this->get_project_division_district_upazila_reports($args);
...
$count_results = $this->get_project_division_district_upazila_reports($args);
...
if ($_GET['download_csv']) {
    unset($args['limit']);
    $data = $this->get_project_division_district_upazila_reports($args);
    $data = $data['data'];
    ...
    $csvFile = $csvFolder . 'Project_Division_District_Upazila_Wise_MIS_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Project, Division, District, and Upazila Wise MIS Report', '');
...
<div class="page-header">
    <h1>Project, Division, District, and Upazila MIS Reports</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            <?php
            echo linkButtonGenerator(array(
                'href' => '?download_csv=1&project=' . $filter_project . '&division=' . $filter_division . '&district=' . $filter_district . '&sub_district=' . $filter_sub_district,
