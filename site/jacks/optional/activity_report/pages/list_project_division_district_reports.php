...
$results = $this->get_project_division_district_reports($args);
...
$count_results = $this->get_project_division_district_reports($args);
...
if ($_GET['download_csv']) {
    unset($args['limit']);
    $data = $this->get_project_division_district_reports($args);
    $data = $data['data'];
...
<div class="page-header">
    <h1>Project, Division and District MIS Reports</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            <?php
            echo linkButtonGenerator(array(
                'href' => '?download_csv=1&project=' . $filter_project . '&division=' . $filter_division . '&district=' . $filter_district,
...
<div class="table-primary table-responsive">
    ...
    <div class="table-header">
        <?php echo searchResultText($results['total'], $start, $per_page_items, count($results['data']), 'Project, Division and District MIS Report') ?>
    </div>
