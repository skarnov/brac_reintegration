...
$results = $this->get_division_district_upazila_reports($args);
...
$count_results = $this->get_division_district_upazila_reports($args);
...
if ($_GET['download_csv']) {
    unset($args['limit']);
    $data = $this->get_division_district_upazila_reports($args);
    $data = $data['data'];
...
<div class="page-header">
    <h1>Division, District and Upazila MIS Reports</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <div class="table-header">
        <?php echo searchResultText($results['total'], $start, $per_page_items, count($results['data']), 'Division, District and Upazila MIS Report') ?>
    </div>
