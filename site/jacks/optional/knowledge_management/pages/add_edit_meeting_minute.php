...
if (!checkPermission($edit, 'add_meeting_minute', 'edit_meeting_minute')) {
...
if ($_POST) {
    ...
    if ($ret['success']) {
        ...
        if ($edit) {
            header('location: ' . url('admin/dev_knowledge_management/manage_meeting_minutes?action=add_edit_meeting_minute&edit=' . $edit));
        } else {
            header('location: ' . url('admin/dev_knowledge_management/manage_meeting_minutes'));
        }
        exit();
    } else {
        $pre_data = $_POST;
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?> Meeting Minute </h1>
    <div class="oh">
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        ...
        <div class="panel-footer tar">
            <a href="<?php echo url('admin/dev_knowledge_management/manage_meeting_minutes') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
            <?php
