...
if (!checkPermission($edit, 'add_project_document', 'edit_project_document')) {
...
if ($edit) {
    ...
    if (!$pre_data) {
        add_notification('Invalid meeting minute, no data found.', 'error');
...
if ($_POST) {
    ...
    if ($ret['success']) {
        ...
        if ($edit) {
            header('location: ' . url('admin/dev_knowledge_management/manage_project_documents?action=add_edit_project_document&edit=' . $edit));
        } else {
            header('location: ' . url('admin/dev_knowledge_management/manage_project_documents'));
        }
        exit();
    } else {
        $pre_data = $_POST;
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?> Project Document </h1>
    <div class="oh">
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        ...
        <div class="panel-footer tar">
            <a href="<?php echo url('admin/dev_knowledge_management/manage_project_documents') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
            <?php
