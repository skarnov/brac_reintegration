...
if ($edit) {
    $args = array(
        'select_fields' => array(
            'district_id' => 'bd_post_offices.district_id',
            'post_office_name' => 'bd_post_offices.name AS name',
            'post_office_bn_name' => 'bd_post_offices.bn_name AS bn_name',
        ),
        'id' => $edit,
        'single' => true
    );
    $pre_data = $this->get_post_offices($args);
...
if ($_POST) {
    ...
    $ret = $this->add_edit_post_office($data);
    ...
    if ($ret['success']) {
        ...
        header('location: ' . url('admin/dev_location_management/manage_post_offices'));
        exit();
    } else {
        $pre_data = $_POST;
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?>Post Office</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            ...
            echo linkButtonGenerator(array(
                'href' => $myUrl,
                'action' => 'list',
                'text' => 'All Post Office Management',
                'title' => 'Manage Post Office Management',
                'icon' => 'icon_list',
                'size' => 'sm'
            ));
            ?>
