...
if ($edit) {
    $args = array(
        'select_fields' => array(
            'district_id' => 'bd_police_stations.district_id',
            'police_station_name' => 'bd_police_stations.name AS name',
            'police_station_bn_name' => 'bd_police_stations.bn_name AS bn_name',
        ),
        'id' => $edit,
        'single' => true
    );
    $pre_data = $this->get_police_stations($args);
...
if ($_POST) {
    ...
    $ret = $this->add_edit_police_station($data);
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?>Police Station</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            ...
            echo linkButtonGenerator(array(
                'href' => $myUrl,
                'action' => 'list',
                'text' => 'All Police Station Management',
                'title' => 'Manage Police Station Management',
                'icon' => 'icon_list',
                'size' => 'sm'
            ));
            ?>
