...
$result = $this->get_divisions($args);
$pagination = pagination($result['total'], $per_page_items, $start);

doAction('render_start');
?>
<div class="page-header">
    <h1>All Division Management</h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            <?php
            echo linkButtonGenerator(array(
                'href' => $myUrl . '?action=add_edit_division',
                'action' => 'add',
                'icon' => 'icon_add',
                    ...
                    <td class="tar action_column">
                        <?php if (has_permission('edit_location')): ?>
                            <div class="btn-group btn-group-sm">
                                <?php
                                echo linkButtonGenerator(array(
                                    'href' => build_url(array('action' => 'add_edit_division', 'edit' => $value['id'])),
                                    'action' => 'edit',
                                    'icon' => 'icon_edit',
                                    'text' => 'Edit',
                                    'title' => 'Edit Division',
