...
$pre_data = array();
if ($edit) {
    $pre_data = $this->get_workshop_participants(array('id' => $edit, 'single' => true));    
...
if ($_POST) {
    ...
    $data['fk_workshop_id'] = $workshop_id;
    $data['edit'] = $edit;

    $ret = $this->add_edit_workshop_participants($data);
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?> Workshop Participants</h1>
    ...
    <div class="oh">
        <div class="btn-group btn-group-sm">
            ...
            echo linkButtonGenerator(array(
                'href' => $myUrl . '?action=participants_list&workshop_id=' . $workshop_info['pk_workshop_id'],
                'action' => 'list',
                'text' => 'All Workshop Participants',
                'title' => 'Manage Workshop Participants',
                'icon' => 'icon_list',
                'size' => 'sm'
            ));
            ?>
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label input-label">Division <?php echo $pre_data['permanent_division'] ?></label>
