...
if (!checkPermission($edit, 'add_workshop_validation', 'edit_workshop_validation')) {
...
if ($edit) {
    $pre_data = $this->get_workshop_validations(array('id' => $edit, 'single' => true));

    if (!$pre_data) {
        add_notification('Invalid workshop validation, no data found.', 'error');
...
if ($_POST) {
    ...
    $ret = $this->add_edit_workshop_validation($data);

    if ($ret) {
        $msg = "Workshop validation has been " . ($edit ? 'updated.' : 'saved.');
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?> Workshop Validation </h1>
    <div class="oh">
        <div class="btn-group btn-group-sm">
            <?php
            echo linkButtonGenerator(array(
                'href' => $myUrl . '?action=workshop_validation&workshop_id=' . $workshop_id,
                'action' => 'list',
                'text' => 'All Workshop Validations',
                'title' => 'Manage Workshop Validations',
                'icon' => 'icon_list',
                'size' => 'sm'
            ));
            ?>
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-4">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Organization of The Workshop</legend>
                    <div class="form-group">
                        <label>How satisfied are you with the contents of workshop/workshop</label>
                        <div class="select2-success">
                            <select class="form-control" id="" name="satisfied_workshop" >
                                <option value="">Select One</option>
                                <option value="5" <?php echo $pre_data && $pre_data['satisfied_workshop'] == '5' ? 'selected' : '' ?>>Very Satisfied</option>
                                <option value="4" <?php echo $pre_data && $pre_data['satisfied_workshop'] == '4' ? 'selected' : '' ?>>Satisfied</option>
                                <option value="3" <?php echo $pre_data && $pre_data['satisfied_workshop'] == '3' ? 'selected' : '' ?>>Ok</option>
                                <option value="2" <?php echo $pre_data && $pre_data['satisfied_workshop'] == '2' ? 'selected' : '' ?>>Dissatisfied</option>
                                <option value="1" <?php echo $pre_data && $pre_data['satisfied_workshop'] == '1' ? 'selected' : '' ?>>Very Dissatisfied</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>How satisfied are you with the workshop venue and other logistic supports</label>
                        <div class="select2-success">
                    ...
                    <div class="form-group">
                        <label>How satisfied are you with the workshop/workshop facilitation</label>
                        <div class="select2-success">
            ...
            <div class="col-md-4">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Outcome of The Workshop</legend>
                    <div class="form-group">
                        <label>What extent your knowledge increased on NPA</label>
                        <div class="select2-success">
                            <select class="form-control" id="" name="outcome_workshop" >
                                <option value="">Select One</option>
                                <option value="5" <?php echo $pre_data && $pre_data['outcome_workshop'] == '5' ? 'selected' : '' ?>>Very Satisfied</option>
                                <option value="4" <?php echo $pre_data && $pre_data['outcome_workshop'] == '4' ? 'selected' : '' ?>>Satisfied</option>
                                <option value="3" <?php echo $pre_data && $pre_data['outcome_workshop'] == '3' ? 'selected' : '' ?>>Ok</option>
                                <option value="2" <?php echo $pre_data && $pre_data['outcome_workshop'] == '2' ? 'selected' : '' ?>>Dissatisfied</option>
                                <option value="1" <?php echo $pre_data && $pre_data['outcome_workshop'] == '1' ? 'selected' : '' ?>>Very Dissatisfied</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="panel-footer tar">
        <a href="<?php echo url('admin/dev_activity_management/manage_workshops') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
        <?php
