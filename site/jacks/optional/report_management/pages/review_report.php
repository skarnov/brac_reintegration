...
if ($filter_entry_start_date && $filter_entry_start_date) {
    $args['BETWEEN_INCLUSIVE'] = array(
        'social_support_entry_date' => array(
...
if ($_GET['download_csv']) {
    ...
    $csvFile = $csvFolder . 'Review_and_Follow-up-Report' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Review and Follow-up Report', '');
    ...
    $headers = array(
        ...
        'Present Support Status',
        'Type of support received',
        'Confirmed Services Received after 3 Months',
        'Other Financial Service',
        'Psychosocial Support - Visit Date',
        'Psychosocial Support - Problem',
        'Psychosocial Support - Action Taken',
        'Psychosocial Support - Participant Remark',
        'Psychosocial Support - Counselor Remark',
        'Economic Support - Visit Date',
        'Economic Support - Monthly Average Income (BDT)',
        'Economic Support - Challenges',
        'Economic Support - Action Taken',
        'Economic Support - Significant changes',
        'Economic Support - Participant Remark',
        'Economic Support - BRAC Officer Remark',
        'Economic Support - RSC Manager Remark',
        'Social Support - Visit Date',
        'Social Support - Challenges',
        'Social Support - Action Taken',
        'Social Support - Significant changes',
        'Social Support - Participant Remark',
        'Social Support - BRAC Officer Remark',
        'Social Support - RSC Manager Remark',
    );
    ...
    if ($data) {
        ...
        foreach ($data as $value) {
            $dataToSheet = array(
                ...
                , ucfirst($value['support_status'])
                , $value['support_received']
                , $value['confirm_services']
                , $value['followup_financial_service']
                , $value['psychosocial_date'] && $value['psychosocial_date'] != '0000-00-00' ? date('d-m-Y', strtotime($value['psychosocial_date'])) : 'N/A'
                , $value['psychosocial_problem']
                , $value['psychosocial_action']
                , $value['psychosocial_participant']
                , $value['psychosocial_counselor']
                , $value['economic_date'] && $value['economic_date'] != '0000-00-00' ? date('d-m-Y', strtotime($value['economic_date'])) : 'N/A'
                , $value['monthly_average_income']
                , $value['economic_challenges']
                , $value['economic_action']
                , $value['significant_changes'] . ' ' . $value['other_significant_changes']
                , $value['economic_participant']
                , $value['economic_officer']
                , $value['economic_manager']
                , $value['social_date'] && $value['social_date'] != '0000-00-00' ? date('d-m-Y', strtotime($value['social_date'])) : 'N/A'
                , $value['social_challenges']
                , $value['social_action']
                , $value['social_changes']
                , $value['social_participant']
                , $value['social_officer']
...
<div class="page-header">
    <h1>Review and Follow-up Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Review and Follow-up') ?>
    </div>
    <table class="table table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th>Confirmed Services Received after 3 Months</th>
            </tr>
        </thead>
        <tbody>
            <?php
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td class="text-capitalize"><?php echo $case['support_status'] ?></td>
                    <td class="text-capitalize"><?php echo $case['support_received'] ?></td>
                    <td><?php echo $case['confirm_services'] ?></td>
                </tr>
                <?php
            }
            ?>
