...
if (!$report):
    ...
    header('location: ' . url('admin/dev_report_management/pdf_case_report'));
    exit();
endif;
...
$family_counselings = $customers->get_family_counseling(array('customer_id' => $customer_id));
...
$economic_referrals = $customers->get_economic_referrals(array('customer_id' => $customer_id));
$received_economic_referrals = $customers->get_economic_referral_received(array('customer_id' => $customer_id));
...
if (in_array('financial_literacy', $report)) :
...
if (in_array('economic_referrals_received', $report)) :
    $devPdf->SetFont('Times', 'B', 14);
...
if (in_array('medical_support', $report)) :
    $devPdf->SetFont('Times', 'B', 14);
