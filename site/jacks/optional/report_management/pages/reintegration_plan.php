...
$args = array(
    'reintegration_plan_only' => TRUE,
    'select_fields' => array(
        'customer_id' => 'dev_customers.customer_id',
        'project_short_name' => 'dev_projects.project_short_name',
        'entry_date' => 'dev_reintegration_plan.plan_date AS entry_date',
        'create_date' => 'dev_reintegration_plan.create_date',
    ...
    'order_by' => array(
        'col' => 'dev_reintegration_plan.fk_customer_id',
        'order' => 'DESC'
    ),
);
...
if ($_GET['download_csv']) {
    ...
    $csvFile = $csvFolder . 'Preferred_Services_and_Reintegration_Plan_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Preferred Services and Reintegration Plan Report', '');
    ...
    if ($data) {
        ...
        foreach ($data as $value) {
            $dataToSheet = array(
                ...
                , $value['reintegration_financial_service']
                , $value['service_requested']
                , $value['other_service_requested']
                , $value['social_protection']
                , $value['security_measure']
                , $value['service_requested_note']
            );
...
<div class="page-header">
    <h1>Preferred Services and Reintegration Plan Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Reintegration Plan') ?>
    </div>
        ...
        <tbody>
            ...
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td><?php echo $case['reintegration_financial_service'] ?></td>
                    <td><?php echo $case['service_requested'] . ' ' . $case['other_service_requested'] ?></td>
                    <td><?php echo $case['service_requested_note'] ?></td>
                    <td><?php echo $case['social_protection'] ?></td>
                    <td><?php echo $case['security_measure'] ?></td>
                </tr>
                <?php
            }
            ?>
