...
$args = array(
    ...
    'select_fields' => array(
        ...
        'entry_time' => 'dev_psycho_followups.entry_time',
        'session_end_time' => 'dev_psycho_followups.session_end_time',
        'followup_comments' => 'dev_psycho_followups.followup_comments',
    ),
    ...
    'order_by' => array(
        'col' => 'dev_psycho_followups.fk_customer_id',
        'order' => 'DESC'
    ),
);
...
if ($_GET['download_csv']) {
    $args['select_fields'] = array(
        ...
        'entry_date' => 'dev_psycho_followups.entry_date',
        'create_date' => 'dev_psycho_followups.create_date',
        'entry_time' => 'dev_psycho_followups.entry_time',
        'session_end_time' => 'dev_psycho_followups.session_end_time',
        'followup_comments' => 'dev_psycho_followups.followup_comments',
    );
    ...
    $csvFile = $csvFolder . 'Followup_Psychosocial_Reintegration_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Followup Psychosocial Reintegration Report', '');
...
<div class="page-header">
    <h1>Followup Psychosocial Reintegration Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Followup Psychosocial') ?>
    </div>
        ...
        <tbody>
            ...
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td><?php echo $case['followup_comments']; ?></td>
                </tr>
                <?php
            }
            ?>
