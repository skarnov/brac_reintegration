...
$args = array(
    ...
    'select_fields' => array(
        ...
        'entry_time' => 'dev_psycho_family_counselling.entry_time',
        'session_end_time' => 'dev_psycho_family_counselling.session_end_time',
        'session_place' => 'dev_psycho_family_counselling.session_place',
        'activities_description' => 'dev_psycho_family_counselling.activities_description',
        'session_comments' => 'dev_psycho_family_counselling.session_comments',
        'male_counseled' => 'dev_psycho_family_counselling.male_counseled',
        'female_counseled' => 'dev_psycho_family_counselling.female_counseled',
        'members_counseled' => 'dev_psycho_family_counselling.members_counseled',
    ),
    ...
    'order_by' => array(
        'col' => 'dev_psycho_family_counselling.fk_customer_id',
        'order' => 'DESC'
    ),
);
...
if ($_GET['download_csv']) {
    $args['select_fields'] = array(
        ...
        'entry_date' => 'dev_psycho_family_counselling.entry_date',
        'create_date' => 'dev_psycho_family_counselling.create_date',
        'entry_time' => 'dev_psycho_family_counselling.entry_time',
        'session_end_time' => 'dev_psycho_family_counselling.session_end_time',
        'session_place' => 'dev_psycho_family_counselling.session_place',
        'activities_description' => 'dev_psycho_family_counselling.activities_description',
    ...
    $csvFile = $csvFolder . 'Family_Counseling_Session_Activities_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Family Counseling Session Activities Report', '');
    ...
    $headers = array(
        ...
        'Comment of Psychosocial Counselor',
        'Place of Family Counseling',
        'Men Member Counseled',
        'Women Member Counseled',
        'Total Counseled',
    );
    ...
    if ($data) {
        ...
        foreach ($data as $value) {
            $dataToSheet = array(
                ...
                , $value['entry_time']
                , $value['session_end_time']
                , $value['activities_description']
                , $value['session_comments']
                , $value['session_place']
                , $value['male_counseled']
                , $value['female_counseled']
                , $value['members_counseled']
            );
...
<div class="page-header">
    <h1>Family Counseling Session Activities Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Family Counseling') ?>
    </div>
    <table class="table table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th>Comment of Psychosocial Counselor</th>
                <th>Total</th>
        ...
        <tbody>
            ...
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td><?php echo $case['entry_time']; ?></td>
                    <td><?php echo $case['session_end_time']; ?></td>
                    <td><?php echo $case['session_place']; ?></td>
                    <td><?php echo $case['activities_description']; ?></td>
                    <td><?php echo $case['session_comments']; ?></td>
                    <td><?php echo '<b>Male: </b>' . $case['male_counseled'] . '<br/><b>Female: </b>' . $case['female_counseled'] . '<br/><b>Total: </b>' . $case['members_counseled'] ?></td>
                </tr>
                <?php
            }
            ?>
