...
$args = array(
    ...
    'select_fields' => array(
        ...
        'entry_time' => 'dev_psycho_sessions.entry_time',
        'session_end_time' => 'dev_psycho_sessions.session_end_time',
        'session_comments' => 'dev_psycho_sessions.session_comments',
        'activities_description' => 'dev_psycho_sessions.activities_description',
        'next_date' => 'dev_psycho_sessions.next_date',
    ),
    ...
    'order_by' => array(
        'col' => 'dev_psycho_sessions.fk_customer_id',
        'order' => 'DESC'
    ),
);
...
if ($_GET['download_csv']) {
    $args['select_fields'] = array(
        ...
        'entry_date' => 'dev_psycho_sessions.entry_date',
        'create_date' => 'dev_psycho_sessions.create_date',
        'entry_time' => 'dev_psycho_sessions.entry_time',
        'session_end_time' => 'dev_psycho_sessions.session_end_time',
        'session_comments' => 'dev_psycho_sessions.session_comments',
        'activities_description' => 'dev_psycho_sessions.activities_description',
    ...
    $csvFile = $csvFolder . 'Psychosocial_Reintegration_Session_Activities_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Psychosocial Reintegration Session Activities Report', '');
    ...
    if ($data) {
        ...
        foreach ($data as $value) {
            $dataToSheet = array(
                ...
                , $value['next_date'] && $value['next_date'] != '0000-00-00' ? date('d-m-Y', strtotime($value['next_date'])) : 'N/A'
            );
...
<div class="page-header">
    <h1>Psychosocial Reintegration Session Activities Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Psychosocial Session ') ?>
    </div>
        ...
        <tbody>
            ...
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td><?php echo $case['next_date'] == '0000-00-00' ? '' : date('d-m-Y', strtotime($case['next_date'])) ?></td>
                </tr>
                <?php
            }
            ?>
