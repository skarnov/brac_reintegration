...
$args = array(
    ...
    'order_by' => array(
        'col' => 'dev_financial_literacy.fk_customer_id',
        'order' => 'DESC'
    ),
);
...
if ($_GET['download_csv']) {
    ...
    $csvFile = $csvFolder . 'Financial_Literacy_and_Remittance_Management_Training_Report-' . time() . '.csv';

    $fh = fopen($csvFile, 'w');

    $report_title = array('Financial Literacy & Remittance Management Training Report', '');
...
<div class="page-header">
    <h1>Financial Literacy & Remittance Management Training Report</h1>
    <div class="oh">
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($cases['total'], $start, $per_page_items, count($cases['data']), 'Financial Literacy & Remittance Management Training Report') ?>
    </div>
        ...
        <tbody>
            ...
            foreach ($cases['data'] as $i => $case) {
                ...
                <tr>
                    ...
                    <td class="text-capitalize"><?php echo $case['financial_training_received']; ?></td>
                    <td><?php echo $case['financial_institution_name']; ?></td>
                    <td><?php echo $case['financial_training_place']; ?></td>
                    <td class="text-capitalize"><?php echo $case['financial_certification_received']; ?></td>
                </tr>
                <?php
            }
            ?>
